...
import etf.openpgp.kn160458dom160076d.gui.controllers.Home;
import etf.openpgp.kn160458dom160076d.gui.controllers.SendMessage;
...
public class CryptoLogic {
    ...
    public static void sendMessage(SendMessage sendMessageContoller) {
        ...
        try {
            ...
            if (sign) {
                ...
                try{
                    ...
                    sendMessageContoller.showMessage("Wrong password!");
                    return;
                }
    ...
    public static void receive(Home homeController){
        try{
            ...
            try{
                ...
                homeController.showMessage("Decryption failed. ");
                return;
            }
            ...
            while(message != null){
                if(message instanceof PGPEncryptedDataList){
                    ...
                    homeController.message += "Decryption successful\n";
                    continue;
                }
                ...
                if(message instanceof PGPOnePassSignatureList){
                    ...
                    try{
                        ...
                        homeController.showMessage("Error in signature!");
                        return;
                    }
